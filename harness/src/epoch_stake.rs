...
pub fn create_mock_epoch_stake(target_total: u64) -> EpochStake {
    const BASE_STAKE_PER_ACCOUNT: u64 = 100_000_000_000; // 100 TRZ
...
mod tests {
    ...
    fn test_num_accounts_zero() {
        // Target < 100 TRZ, results in num_accounts = 0
    ...
    fn test_num_accounts_one() {
        // 100 TRZ <= target < 200 TRZ, results in num_accounts = 1

        // Exactly 100 TRZ, no remainder
        ...
        // 199.999999999 TRZ, with remainder
    ...
    fn test_num_accounts_two() {
        // 200 TRZ <= target < 300 TRZ, results in num_accounts = 2

        // Exactly 200 TRZ, no remainder -> [100, 100]
        ...
        // 250 TRZ, with remainder -> [100, 150]
        ...
        // 299.999999999 TRZ, with remainder -> [100, 199.999999999]
    ...
    fn test_num_accounts_greater_than_two() {
        // target >= 300 TRZ, results in num_accounts > 2

        // Exactly 300 TRZ, no remainder -> [100, 100, 100]
        ...
        // 350 TRZ, with remainder -> [100, 100, 150]
        ...
        // 1000 TRZ, no remainder -> [100, 100, 100, 100, 100, 100, 100, 100, 100, 100]
        ...
        // 1234.567890123 TRZ, with remainder
        ...
        let mut stakes: Vec<u64> = epoch_stake.values().copied().collect();
        stakes.sort();
        // Should have 11 accounts with 100 TRZ and 1 account with 134.567890123 TRZ
