...
trezoa_pubkey::declare_id!("239vxAL9Q7e3uLoinJpJ873r3bvT9sPFxH7yekwPppNF");
...
fn process_instruction(
    ...
    match input.split_first() {
        ...
        Some((3, _)) => {
            ...
            account_info.assign(&trezoa_sdk_ids::system_program::id());
